...
export default function PanierPage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-md pb-16 sm:max-w-2xl lg:max-w-5xl">
      ...
      <div className="px-5">
        ...
        {hydrated && items.length === 0 && (
          <GlowCard toneRgb={catalogToneRgb.electric} className="bounce-in mt-4 mx-auto max-w-md text-center">
        ...
        {hydrated && items.length > 0 && (
          <div className="mt-4 lg:grid lg:grid-cols-[1fr_360px] lg:items-start lg:gap-6">
            <div>
            ...
            <div className="mt-6 lg:sticky lg:top-6 lg:mt-0">
              <GlowCard toneRgb={totalToneRgb} particles className="bounce-in">
